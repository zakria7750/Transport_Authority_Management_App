...
export const DRIVERS_DATA: Driver[] = [
  {
    ...
    compensationBalance: 0, separator: "أ", joinDate: "2023-05-10",
    guarantors: [
  ...
  },
  {
    ...
    compensationBalance: 1500, separator: "م", joinDate: "2023-06-20",
    guarantors: [{ id: 3, name: "علي الغامدي", phone: "0508765432", status: "فعال", nationalId: "1045678901" }],
  },
  {
    id: 3, seq: 0, ownerName: "عبدالله سعد القحطاني", type: "س", plate: "ر ز م 9012",
    phone: "0503456789", status: "غير_نشط", statusReason: "مخالف_ت", currentTrip: null, violation: "ت",
    compensationBalance: 0, separator: "ع", joinDate: "2023-07-15",
    guarantors: [{ id: 4, name: "سعد القحطاني", phone: "0504321098", status: "فعال", nationalId: "1056789012", suspended: true, suspendedForViolatorId: 3 }],
  },
  {
    id: 4, seq: 3, ownerName: "سلطان فهد الشمري", type: "ع", plate: "ح ط س 3456",
    phone: "0504567890", status: "نشط", statusReason: null, currentTrip: null, violation: null,
    compensationBalance: 2000, separator: "س", joinDate: "2023-08-01",
    guarantors: [
  ...
  {
    id: 5, seq: 0, ownerName: "خالد عمر الزهراني", type: "س", plate: "ع ز ث 7890",
    phone: "0505678901", status: "غير_نشط", statusReason: "مفروز", currentTrip: null, violation: null,
    compensationBalance: 0, separator: "خ", joinDate: "2023-04-05", guarantors: [],
  },
  {
    id: 6, seq: 4, ownerName: "فيصل ناصر الحربي", type: "ع", plate: "ب ج ح 2345",
    phone: "0506789012", status: "نشط", statusReason: null, currentTrip: "م1", violation: null,
    compensationBalance: 500, separator: "ف", joinDate: "2023-09-12",
    guarantors: [{ id: 7, name: "حمد الحربي", phone: "0501234987", status: "فعال", nationalId: "1089012345" }],
  },
  {
    id: 7, seq: 0, ownerName: "عمر سعيد العتيبي", type: "س", plate: "م ن ع 6789",
    phone: "0507890123", status: "غير_نشط", statusReason: "مخالف_ح", currentTrip: null, violation: "ح",
    compensationBalance: 0, separator: "ع", joinDate: "2023-03-20", guarantors: [],
  },
  {
    id: 8, seq: 5, ownerName: "عبدالرحمن حمد الدوسري", type: "ع", plate: "ل و ص 0123",
    phone: "0508901234", status: "نشط", statusReason: null, currentTrip: "م2", violation: null,
    compensationBalance: 3200, separator: "ع", joinDate: "2023-10-08",
    guarantors: [
  ...
  {
    id: 9, seq: 0, ownerName: "تركي يوسف الرشيدي", type: "س", plate: "د ه ت 4567",
    phone: "0509012345", status: "غير_نشط", statusReason: "بدون_ضمانة", currentTrip: null, violation: null,
    compensationBalance: 0, separator: "ت", joinDate: "2023-11-01", guarantors: [],
  },
  {
    id: 10, seq: 6, ownerName: "نواف عبدالعزيز السبيعي", type: "ع", plate: "ك ل م 8901",
    phone: "0500123456", status: "نشط", statusReason: null, currentTrip: null, violation: null,
    compensationBalance: 800, separator: "ن", joinDate: "2023-12-15",
    guarantors: [{ id: 10, name: "يوسف السبيعي", phone: "0503219876", status: "فعال", nationalId: "1012345678" }],
  },
  {
    id: 11, seq: 7, ownerName: "بدر عبدالله المطيري", type: "س", plate: "ث ج خ 2345",
    phone: "0501239876", status: "نشط", statusReason: null, currentTrip: null, violation: null,
    compensationBalance: 1200, separator: "ب", joinDate: "2024-01-05",
    guarantors: [{ id: 11, name: "فهد المطيري", phone: "0506789123", status: "فعال", nationalId: "1023456780" }],
  },
  {
    id: 12, seq: 8, ownerName: "وليد محمد العنزي", type: "ع", plate: "ذ ر ز 6789",
    phone: "0502348765", status: "نشط", statusReason: null, currentTrip: "تعويض", violation: null,
    compensationBalance: 0, separator: "و", joinDate: "2024-01-10",
    guarantors: [{ id: 12, name: "مشعل العنزي", phone: "0508765901", status: "فعال", nationalId: "1034567801" }],
  },
  {
    id: 13, seq: 0, ownerName: "راشد سعد الثبيتي", type: "س", plate: "ط ظ ع 0123",
    phone: "0503457654", status: "غير_نشط", statusReason: "ملغي", currentTrip: null, violation: null,
    compensationBalance: 0, separator: "ر", joinDate: "2023-02-14", guarantors: [],
  },
  {
    id: 14, seq: 9, ownerName: "حمدان علي الهاجري", type: "ع", plate: "غ ف ق 4567",
    phone: "0504566543", status: "نشط", statusReason: null, currentTrip: null, violation: null,
    compensationBalance: 600, separator: "ح", joinDate: "2024-01-12",
    guarantors: [{ id: 13, name: "جاسم الهاجري", phone: "0501238765", status: "فعال", nationalId: "1045678012" }],
  },
  {
    id: 15, seq: 0, ownerName: "ماجد عبدالله الشهري", type: "س", plate: "ك ل م 8902",
    phone: "0505675432", status: "غير_نشط", statusReason: "مخالف_ت", currentTrip: null, violation: "ت",
    compensationBalance: 0, separator: "م", joinDate: "2024-01-14",
    guarantors: [{ id: 14, name: "عبدالله الشهري", phone: "0509876234", status: "فعال", nationalId: "1056789023" }],
  },
]

export const TRIPS_DATA: Trip[] = [
  { id: 1, driverId: 2, type: "فرزة", payload: "قمح", province: "صنعاء", destinationType: "فرع", destination: "عدن", breakNum: "F001", status: "مؤكدة_مبدئياً", createdAt: "2024-01-15 08:30" },
  { id: 2, driverId: 6, type: "م1", payload: "أسمنت", province: "تعز", destinationType: "وكيل", destination: "الحديدة", breakNum: "M101", status: "مؤكدة_مبدئياً", createdAt: "2024-01-15 09:15" },
  { id: 3, driverId: 8, type: "م2", payload: "حديد", province: "حضرموت", destinationType: "تصدير", destination: "ميناء", breakNum: "M201", status: "مؤكدة_مبدئياً", createdAt: "2024-01-15 10:00" },
  { id: 4, driverId: 12, type: "تعويض", payload: "-", province: "صنعاء", destinationType: "فرع", destination: "-", breakNum: "T001", status: "مؤكدة_مبدئياً", createdAt: "2024-01-15 11:30", compensationAmount: 4500 },
  { id: 5, driverId: 1, type: "فرزة", payload: "أغذية", province: "صنعاء", destinationType: "فرع", destination: "إب", breakNum: "F002", status: "مكتملة", createdAt: "2024-01-14 07:00", completedAt: "2024-01-14 18:00" },
  { id: 6, driverId: 4, type: "م1", payload: "رمل", province: "عدن", destinationType: "وكيل", destination: "تعز", breakNum: "M102", status: "مكتملة", createdAt: "2024-01-13 08:00", completedAt: "2024-01-13 17:30" },
  { id: 7, driverId: 10, type: "م2", payload: "حصى", province: "حضرموت", destinationType: "تصدير", destination: "المكلا", breakNum: "M202", status: "مكتملة", createdAt: "2024-01-12 09:00", completedAt: "2024-01-12 20:00" },
  { id: 8, driverId: 11, type: "فرزة", payload: "تمور", province: "حجة", destinationType: "فرع", destination: "صنعاء", breakNum: "F003", status: "مكتملة", createdAt: "2024-01-11 07:30", completedAt: "2024-01-11 19:00" },
]

export const VIOLATIONS_DATA: Violation[] = [
  { id: 1, driverId: 3, driverName: "عبدالله سعد القحطاني", type: "ت", date: "2024-01-15", raised: false, note: "غياب عن كشف التحضير" },
  { id: 2, driverId: 7, driverName: "عمر سعيد العتيبي", type: "ح", date: "2024-01-14", raised: false, note: "تجاوز الحمولة المسموحة بـ 20%" },
  { id: 3, driverId: 15, driverName: "ماجد عبدالله الشهري", type: "ت", date: "2024-01-15", raised: false, note: "غياب عن كشف التحضير" },
  ...
  { id: 5, driverId: 4, driverName: "سلطان فهد الشمري", type: "ح", date: "2024-01-08", raised: true, raisedDate: "2024-01-09", note: "تجاوز الوزن المحدد" },
]
